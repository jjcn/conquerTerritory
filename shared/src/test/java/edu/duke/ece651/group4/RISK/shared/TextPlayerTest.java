...
class TextPlayerTest {
    ...
    void test_doOneAction() throws IOException {
        ...
        String input = "M\nsrc1\ndes1\n12\n" + "A\nsrc2\ndes2\n4t\n3\n" + "k\nD\n";
        String name = "Red";
        TextPlayer player = createTextPlayer(bytes, input, name);
        Order o1 = player.doOneAction();
        Order o2 = player.doOneAction();
        Order o3 = player.doOneAction();

        String instr = name + " what would you like to do?\n(A)ttack\n(M)ove\n(D)one\n\n";
...
//        assertEquals(expected, bytes.toString());
    ...
    @Test
    void test_equals() {
        TextPlayer p1 = new TextPlayer(null, null, "p1");
        TextPlayer p2 = new TextPlayer(null, null, "p2");
        TextPlayer p3 = new TextPlayer(null, null, "p2");
        String a = "";
