...
class WorldTextViewTest {
    ...
    void displayWorld() {
        ...
        Territory terrtest = new Territory("test", p1, 2, new Random(0));
        ...
        System.out.print(terrtest.getOwner().getName());
        ...
        String expected = "p1 Player:\n" +
                ...
                "3 units in terr2 (next to: terr1terr3)\n\n" +
                "p2 Player:\n" +
                "-----------\n" +
                "1 units in terr3 (next to: terr2terr4)\n" +
