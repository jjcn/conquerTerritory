...
//        Territory test= new Territory("test",p1,2,new Random(0));
//        test.sendInEnemyTroop(new Troop(2,new TextPlayer(null,"p2",null,null)));
//        test.sendInEnemyTroop(new Troop(2,new TextPlayer(null,"p3",null,null)));
//
//        assertEquals(test.checkPopulation(),1);
//        assertEquals(test.getOwner(),p1);
//
//    }
}